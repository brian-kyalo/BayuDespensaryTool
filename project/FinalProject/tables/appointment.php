...
<body>
    ...
    <main class="table">
        <section class="tbl_header">
            <h1>Bayu Dispensary | Patient Appointments</h1>
            <p>The table displays Patient Appointments</p>
        </section>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <ion-icon  style="font-size: 1.4rem; margin-top: 15px; display:flex; font-weight:1500;" name="cloud-done-outline" class="conclude-appointment" data-doctor-id="<?php echo $row["doctorId"]; ?>"></ion-icon>
                            </td>
                        </tr>
                    <?php
                    };
    ...
    <div class="appointmentForm" id="appointment-modal" style="display: none;">
        ...
        <form class="form" id="appointment-form" action="done1.php" method="POST">

        <input type="hidden" name="completedappointmetId" id="completedappointmetId">
