...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['doctor_submit'])) {
        ...
        exit;
    } elseif (isset($_POST['patient_submit'])) {
        $name = $_POST['name'];
        $email = $_POST['email'];
        $password = $_POST['password'];
...
<html lang="en">
    ...
    <nav>
        ...
        <div class="sub-menu-wrap" id="subMenu">
            ...
            <div class = 'open'>
                <h1><span class="one1">Welcome to Bayu Dispensary</span> </h1>
                ...
                <div class="form">
                    <form action="" method="post">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="serviceNo" placeholder="3022" autocomplete="off" readonly onclick="this.removeAttribute('readOnly')"; required>
                        ...
                        <div>
                            <button type="submit" name="doctor_submit">SignUp as Doctor</button>
                        </div>
                        <div class="register">
                            <p>If you have an account <a href="loginDoc.php">Sign in</a></p>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <section class="footer">
            <div class="container">
                <div class="box">
                    ...
                    <a href=""><i class="fas fa-angle-right"></i>Medical-Specialist</a>
                    <a href=""><i class="fas fa-angle-right"></i>Pharmacy</a>
                    <a href=""><i class="fas fa-angle-right"></i>Book-Appointment</a>
                ...
                <div class="box">
                    <h3>Contact Us</h3>
                    <a href=""><i class="fas fa-phone"></i>+254705659252</a>
                    <a href=""><i class="fas fa-phone"></i>+254789654521</a>
                    <a href=""><i class="fas fa-envelope"></i>brianmuthama15@gmail.com</a>
                    <a href=""><i class="fas fa-map"></i>Nairobi, South C -00100</a>
                </div>
        
                <div class="box">
                    <h3>Follow Us</h3>
                    <a  href=""><i style="color: blue;" class="fab fa-facebook"></i>Facebook</a>
                    <a href=""><i style="color: rgb(0, 213, 255);" class="fab fa-twitter"></i>Twitter</a>
                    <a href=""><i style="color: red;" class="fab fa-instagram"></i>Instagram</a>
                    <a href=""><i class="fab fa-linkedin"></i>Linked-in</a>
                </div>
            </div>
            <div class="credit">
                <hr width="100%" size="4" color="white" noshade>
                Created by <span>Brian Kyalo web desinger</span> | all rights reserved!
            </div>
        </section>
        <script>
