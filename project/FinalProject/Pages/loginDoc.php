...
<html lang="en">
    <head>
        <link rel="stylesheet" href="../finalStyle/loginDoc.css">`
            ...
            <div class="form-box">
                <div class="form">
                    <form action="" method = "post" >
                        ...
                        <div class="input-box">
                            <ion-icon name="lock-closed-outline"></ion-icon>
                            <input type="password" name = "password" autocomplete = "new-password" readonly onclick="this.removeAttribute('readOnly')"; required>
